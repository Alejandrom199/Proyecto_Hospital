...
namespace CapaPersistencia
{
    public class ConnectionDB
    {
        ...
        private SqlConnection cadena_conexion = new SqlConnection("Data Source=ALEJANDRO-PC;Persist Security Info=True;User ID=sa;Password=sa;Trust Server Certificate=True");
